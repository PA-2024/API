...
namespace API_GesSIgn.Migrations
{
    ...
    [Migration("20240714100358_tokenReset")]
    partial class tokenReset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_GesSIgn.Models.AnswerQCM", b =>
                {
                    b.Property<int>("AnswerQCM_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnswerQCM_Id"));

                    b.Property<string>("AnswerQCM_Answer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("AnswerQCM_QCM_Id")
                        .HasColumnType("int");

                    b.Property<int>("AnswerQCM_Question_Id")
                        .HasColumnType("int");

                    b.Property<int>("AnswerQCM_Student_id")
                        .HasColumnType("int");

                    b.HasKey("AnswerQCM_Id");

                    b.HasIndex("AnswerQCM_QCM_Id");

                    b.HasIndex("AnswerQCM_Question_Id");

                    b.HasIndex("AnswerQCM_Student_id");
            ...
            modelBuilder.Entity("API_GesSIgn.Models.Presence", b =>
                {
                    ...
                    b.Property<int?>("Presence_ProofAbsence_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Presence_ProofAbsence_Id");
            ...
            modelBuilder.Entity("API_GesSIgn.Models.ProofAbsence", b =>
                {
                    b.Property<int>("ProofAbsence_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProofAbsence_Id"));

                    b.Property<string>("ProofAbsence_ReasonAbscence")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProofAbsence_SchoolCommentaire")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ProofAbsence_Status")
                        .HasColumnType("int");

                    b.Property<string>("ProofAbsence_UrlFile")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ProofAbsence_Id");

                    b.ToTable("ProofAbsences");
                });
            ...
            modelBuilder.Entity("API_GesSIgn.Models.User", b =>
                {
                    ...
                    b.Property<string>("User_tokenReset")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("API_GesSIgn.Models.AnswerQCM", b =>
                {
                    b.HasOne("API_GesSIgn.Models.QCM", "AnswerQCM_QCM")
                        .WithMany()
                        .HasForeignKey("AnswerQCM_QCM_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_GesSIgn.Models.Question", "AnswerQCM_Question")
                        .WithMany()
                        .HasForeignKey("AnswerQCM_Question_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_GesSIgn.Models.Student", "AnswerQCM_Student")
                        .WithMany()
                        .HasForeignKey("AnswerQCM_Student_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnswerQCM_QCM");

                    b.Navigation("AnswerQCM_Question");

                    b.Navigation("AnswerQCM_Student");
                });
            ...
            modelBuilder.Entity("API_GesSIgn.Models.Presence", b =>
                {
                    b.HasOne("API_GesSIgn.Models.ProofAbsence", "Presence_ProofAbsence")
                        .WithMany()
                        .HasForeignKey("Presence_ProofAbsence_Id")
                    ...
                    b.Navigation("Presence_ProofAbsence");
